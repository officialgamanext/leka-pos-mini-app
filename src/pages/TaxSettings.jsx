...
import { Receipt, Save, Loader2, MapPin, Percent, Info } from 'lucide-react';
    ...
    <AppLayout backPath="/profile">
      <div className="ab-page" style={{ paddingBottom: 100 }}>
        ...
        <div className="ab-hero" style={{ background: 'linear-gradient(170deg, #F59E0B 0%, #D97706 100%)' }}>
          ...
          <div className="ab-hero-icon-wrap"><Receipt size={26} /></div>
          <div className="ab-hero-bg"><Receipt size={110} /></div>
        </div>
        ...
        <motion.form 
          ...
          style={{ marginTop: -20, background: 'var(--surface)', borderRadius: 24, padding: 20, boxShadow: '0 4px 20px rgba(0,0,0,0.05)' }}
        >
          {/* Business Info */}
