        ...
        {isLoading ? (
          ...
          <>
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .06 }} className="db-stats-row">
              ...
              <div className="card db-stat-card">
                <span className="db-stat-label">GST Collected</span>
                <span className="db-stat-value" style={{ color: '#F59E0B' }}>₹{(summary.totalGst || 0).toLocaleString('en-IN')}</span>
              </div>
            </motion.div>
            ...
            {summary.paymentModes && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .1 }} className="db-stats-row payment-method-grid">
                <div className="card db-stat-card" style={{ padding: '12px', flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, color: 'var(--text-sub)' }}>
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .24 }} className="card db-sales-card">
              ...
              {[
                { label: 'All Bills', path: '/all-bills', icon: <ReceiptText size={15} />, color: '#5F259F' },
